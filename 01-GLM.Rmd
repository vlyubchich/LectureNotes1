...
where $b$, $a$, and $c$ are arbitrary functions, $\phi$ and arbitrary `scale' parameter, and $\mu$ is the `canonical parameter' of the distribution. For normal distribution, $\theta = \mu$ and $a(\phi) = \phi= \sigma^2$ [@Wood:2006book].
